...
def init():
    ...
    no_sections = 10
    sections = np.array([[200.0, 50.0, 1.0, 100.0, 0], 
                        [250.0, 50.0, -1.0, 100.0, 0],
                        [200.0, 50.0, -1.0, 100.0, 0],
                        [200.0, 70.0, -1.0, 100.0, 0],
                        [200.0, 75.0, -1.0, 100.0, 0],
                        [200.0, 80.0, -1.0, 100.0, 0],
                        [200.0, 70.0, -1.0, 100.0, 0],
                        [200.0, 90.0, -1.0, 100.0, 0],
                        [200.0, 110.0, -1.0, 100.0, 0],
                        [200.0, 150.0, 1.0, 100.0, 0]])
