...
class network_ui(QtGui.QVBoxLayout): 
    ...
    def setup(self):
        ...
        grid.addWidget(self.le3a, 2, 1)
        grid.addWidget(label3a, 2, 2)
        grid.addWidget(self.le3b, 2, 3)
        grid.addWidget(label3b, 2, 4)
        grid.addWidget(label4, 3, 0)
        grid.addWidget(self.le4a, 3, 1)
        grid.addWidget(label4a, 3, 2)
        grid.addWidget(self.le4b, 3, 3)
        grid.addWidget(label4b, 3, 4)
        grid.addWidget(label5, 4, 0)
        grid.addWidget(self.le5a, 4, 1)
        grid.addWidget(label5a, 4, 2)
        grid.addWidget(self.le5b, 4, 3)
        grid.addWidget(label5b, 4, 4)
        grid.addWidget(label6, 5, 0)
        grid.addWidget(label7, 6, 0)
        grid.addWidget(self.le7, 6, 2)
        grid.addWidget(label7a, 6, 3)
        grid.addWidget(label8, 7, 0)
        grid.addWidget(self.le8, 7, 2)
        grid.addWidget(label9, 8, 0)
        grid.addWidget(self.le9, 8, 2)
    ...
    def update_data(self):
        globals.network_data["freq"] = self.le1.text()
